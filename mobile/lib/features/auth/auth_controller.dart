...
class AppUser {
  ...
  factory AppUser.fromJson(Map<String, dynamic> j) => AppUser(
        ...
        monthlyIncome: ((j['monthlyIncome'] as num?) ?? 0).toInt(),
...
class AuthController extends StateNotifier<AuthState> {
  ...
  /// ล็อกอินด้วย Google → ส่ง idToken/accessToken ให้ backend verify
  Future<bool> loginWithGoogle() async {
    ...
    try {
      ...
      String userMessage = 'ล็อกอิน Google ไม่สำเร็จ กรุณาลองใหม่อีกครั้ง';
      if (kIsWeb && (errStr.contains('deprecated') || errStr.contains('clientid') || errStr.contains('client_id'))) {
        userMessage = 'การล็อกอิน Google บนเว็บ ต้องระบุ Client ID (ดูวิธีตั้งค่า GOOGLE_CLIENT_ID ใน README)';
      }
