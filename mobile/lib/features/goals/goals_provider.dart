...
class GoalsNotifier extends StateNotifier<List<GoalModel>> {
  ...
  Future<void> _loadGoals() async {
    ...
    try {
      ...
      debugPrint('Error loading cached goals from Hive: $e');
      state = user == null ? _initialGoals() : [];
    }
    ...
    if (user != null) {
      try {
        ...
        debugPrint('Error fetching goals from API: $e');
  ...
  Future<void> _saveToHive() async {
    ...
    try {
      ...
      debugPrint('Error saving goals to Hive: $e');
  ...
  Future<void> addGoal(String name, int target, DateTime? deadline, String type,
    ...
    try {
      ...
      if (res.data != null && res.data['goal'] != null && res.data['goal']['id'] != null) {
        final serverId = res.data['goal']['id'].toString();
        state = state.map((g) => g.id == newId ? g.copyWith(id: serverId) : g).toList();
        await _saveToHive();
      }
      _ref.read(authControllerProvider.notifier).refreshProfile();
    } catch (e) {
      debugPrint('Error posting addGoal to API: $e');
    }
  }
  ...
  Future<void> updateGoal(String id, String name, int target, DateTime? deadline,
    ...
    try {
      ...
      debugPrint('Error updating goal on API: $e');
    }
  }
  ...
  Future<void> deleteGoal(String id) async {
    ...
    try {
      ...
      debugPrint('Error deleting goal on API: $e');
    }
  }
  ...
  Future<void> addSavings(String goalId, int amount) async {
    ...
    try {
      ...
      debugPrint('Error adding savings on API: $e');
    }
  }
}
