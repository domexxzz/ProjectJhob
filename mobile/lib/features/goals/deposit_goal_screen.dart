...
class _DepositGoalScreenState extends ConsumerState<DepositGoalScreen> {
  ...
  Widget build(BuildContext context) {
    final goal = ref.watch(goalsProvider).firstWhereOrNull((g) => g.id == widget.goalId);
    if (goal == null) {
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('ไม่พบเป้าหมาย'),
        ),
        body: const Center(
          child: Text('ไม่พบข้อมูลเป้าหมายนี้', style: TextStyle(color: Colors.white)),
        ),
      );
    }
