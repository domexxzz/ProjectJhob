...
class _SpotlightPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (hole == null) {
      canvas.drawPath(Path()..addRect(Offset.zero & size), scrim);
      return;
    }
    ...
    // ใช้ PathFillType.evenOdd เพื่อเจาะรูฉากมืด ให้เห็น UI จริงด้านหลังอย่างโปร่งใส 100% โดยไม่มีสีทับซ้อนจางๆ
    final path = Path()
    ...
    // ตีกรอบสีเขียวเรืองแสงรอบเป้าหมาย
    canvas.drawRRect(
      r,
      Paint()
