...
/**
 * 💡 หมายเหตุสำหรับการ Production (Multi-Instance / Distributed):
 * โดยเริ่มต้น express-rate-limit ใช้ MemoryStore (จำใน RAM ของแต่ละ node process)
 * หากปรับใช้งานแบบหลาย instance หลัง Load Balancer ควรใช้ Redis Store (เช่น rate-limit-redis)
 * เพื่อแชร์สถานะ rate limit ร่วมกันระหว่าง instance ป้องกันการสุ่มกระจาย request แล้ว bypass rate limit
 */
