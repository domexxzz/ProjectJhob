...
const FINANCE_PATTERNS: RegExp[] = [
  // ระบุจำนวนเงิน เช่น "60 บาท", "1,200บาท", "฿50" — สัญญาณการเงินที่ชัดที่สุด (จำเป็นสำหรับการจดรายการผ่านแชท)
  /\d[\d,]*\s*(?:บาท|฿|บ\.|thb)/i,
  // บันทึกแบบสั้น "<ชื่อรายการ> <จำนวน>" เช่น "อาหารตุนหลายวัน 535", "ชอปปี้ 354", "กาแฟ 50" (สไตล์ที่คนพิมพ์จริง)
  // จำกัดชื่อ ≤38 ตัว + ตัวเลขท้ายบรรทัด เพื่อไม่ให้จับประโยคทั่วไปหรือเบอร์โทร
  /^\D.{0,38}\s\d[\d,]*(?:\.\d{1,2})?\s*$/,
  // การกระทำทางการเงิน/บันทึกรายการ เช่น "จ่ายค่ากาแฟ", "ได้เงินเดือน", "โอนให้แม่", "ซื้อของ 200"
  /จ่าย|ชำระ|โอนเงิน|โอนให้|ได้รับเงิน|ได้เงิน|รับเงิน|ถอนเงิน|ฝากเงิน|ค่า(?:อาหาร|ข้าว|กาแฟ|น้ำ|ไฟ|เน็ต|โทร|เดินทาง|รถ|เช่า|ยา|เทอม|เรียน|ขนม)|ซื้อ.{0,20}\d/i,
