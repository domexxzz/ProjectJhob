...
const FINANCE_PATTERNS: RegExp[] = [
  // ระบุจำนวนเงิน เช่น "60 บาท", "10ดอลล่า", "฿50", "10 usd" — สัญญาณการเงินที่ชัดที่สุด
  /\d[\d,]*\s*(?:บาท|฿|บ\.|thb|ดอลลาร์|ดอลล่า|ดอลลา|usd|\$|eur|ยูโร|yen|เยน|cny|หยวน|gbp|ปอนด์|sgd|kwr|วอน)/i,
  // บันทึกแบบสั้น "<ชื่อรายการ> <จำนวน>" เช่น "อาหารตุนหลายวัน 535", "ชอปปี้ 354", "กาแฟ 50" (สไตล์ที่คนพิมพ์จริง)
  /^\D.{0,38}\s\d[\d,]*(?:\.\d{1,2})?\s*$/,
  // การกระทำทางการเงิน/บันทึกรายการ เช่น "จ่ายค่ากาแฟ", "ได้เงินเดือน", "โอนให้แม่", "ซื้อของ 200", "เทรดได้ 10 ดอลล่า"
  /จ่าย|ชำระ|โอนเงิน|โอนให้|ได้รับเงิน|ได้เงิน|รับเงิน|ถอนเงิน|ฝากเงิน|ค่า(?:อาหาร|ข้าว|กาแฟ|น้ำ|ไฟ|เน็ต|โทร|เดินทาง|รถ|เช่า|ยา|เทอม|เรียน|ขนม)|ซื้อ.{0,20}\d|เทรด|forex/i,
  // "เงิน" เป็นภาษาธรรมชาติที่ผู้ใช้ใช้ปรึกษาปัญหาชีวิต
  ...
  /ลงทุน|หุ้น|กองทุน|พันธบัตร|ตราสารหนี้|คริปโต|ทองคำ|พอร์ต|dca|ผลตอบแทน|ปันผล|ความเสี่ยง|เทรด|forex|investment|stock|fund|portfolio|return/i,
  ...
  /เป้าหมายการเงิน|เป้าหมายออม|เป้าหมาย|สร้างเป้าหมาย|goal.*(?:money|saving|finance)/i,
  /สมาชิก|ค่าสมาชิก|subscription/i,
  /มรดก|พินัยกรรม|วางแผนทรัพย์สิน|estate planning/i,
  /เงินเฟ้อ|อัตราแลกเปลี่ยน|สกุลเงิน|ดอลลาร์|ดอลล่า|usd|กี่บาท|เป็นเงินไทย|inflation|exchange rate|currency/i,
